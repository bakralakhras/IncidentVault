...
def upgrade() -> None:
    ...
    op.create_table('reports', sa.Column('id', sa.Integer(), nullable=False), sa.Column(
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('incident_report', sa.Column(
    ...
    op.create_index(op.f('ix_incident_report_id'), 'incident_report', ['id']
                    , unique=False)
